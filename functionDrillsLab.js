...
function faveColorFinder(color){
  if (color === 'red') {
    return 'red is my fave color!'
} else if (color === 'green'){
  return "green is my faveeee color!"
} else if (color === 'black'){
  return "black is the way"
} else {
  return 'you need to find a diff color frfr...'
}
}
...
const bestMovie = title => `${title} is the best movie!!!`
